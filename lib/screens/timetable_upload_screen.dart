                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (!_loading && provider.hasParsedData) ...[
                      _SectionLabel(label: 'Configure Your Timetable'),
                      const SizedBox(height: 16),
                      _ModernDropdown(
                        label: 'Semester',
                    ...
                    if (_savedProfiles.isNotEmpty) ...[
                      ...
                      _SectionLabel(label: 'Saved Timetables'),
                      const SizedBox(height: 16),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: Icon(
                    isNotified ? Icons.notifications_active_rounded : Icons.notifications_off_rounded,
                    color: isNotified ? Theme.of(context).colorScheme.primary : (isDark ? Colors.white38 : Colors.black38),
                    size: 22,
                  ),
